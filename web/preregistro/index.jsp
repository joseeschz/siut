                                ...
                                <form id="formRegister" method="post" >
                                    <div id="tmm-form-wizard" class="form-login substrate">
                                        <div style="position: relative; height: 70px; padding-right: 85px;">
                                            ...
                                            <div class="input-row">
                                                <input title="Ingresa tu nombre de usuario para poder ingresar" name="userNameRegister" style="width: 250px;" maxlength="20" type="text" id="userNameRegister" autofocus="" placeholder="XXXXX">
                                            </div>
                                        </div>
                ...
                $(document).ready(function (){
                    ...
                    $('#formLogin').on('validationSuccess', function (event) {
                        ...
                        $.ajax({
                            type: "POST",
                            async: false,
                            url: "../serviceCandidate?selectLoginCandidate=in",
                            data:datos,
        ...
        <body data-bind="greenUtsem">
            ...
            <div id="content-elements" style="display: none">
                ...
                <div id="culumna-bottom" style="background: #009031 none repeat scroll 0% 0%;">
                    <p>Distribución siut© 2015 Versión 1.10.15 - Universidad Tecnológica Del Sur Del Estado de México</p>
                </div>
            </div>
                                ...
                                if($(".buttonFinish").attr("role")==="close"){
                                    ...
                                    $.ajax({
                                        ...
                                        success: function (data, textStatus, jqXHR) {
                                            ...
                                            $(".buttonFinish").text("Cerrar Sesión");
