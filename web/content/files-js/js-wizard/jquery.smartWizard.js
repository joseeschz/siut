...
function SmartWizard(target, options) {
    ...
    this.loader = $('<div>Guardando</div>').addClass("loader");
    this.buttons = {
        next : $('<a style="display: none;">'+options.labelNext+'</a>').attr("href","#").addClass("buttonNext"),
        previous : $('<a style="display: none;">'+options.labelPrevious+'</a>').attr("href","#").addClass("buttonPrevious"),
