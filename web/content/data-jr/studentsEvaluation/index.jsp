...
<% 
 if(session.getAttribute("logueado") != null){
    if(request.getParameter("sessionCalificationsByStudents")!=null){
        ...
        File reportFile = new File(application.getRealPath("content/data-jr/studentsEvaluation/report.jasper")); 
