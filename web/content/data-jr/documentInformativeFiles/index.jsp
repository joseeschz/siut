...
<% 
 if(session.getAttribute("logueado") != null){
    if(request.getParameter("documentInformativeFile")!=null){
        ...
        File reportFile = new File(application.getRealPath("content/data-jr/documentInformativeFiles/documentInformativeFile.jasper")); 
