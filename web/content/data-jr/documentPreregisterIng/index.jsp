...
<% 
 if(session.getAttribute("logueadoStudentPreregister") != null){    
    if(request.getParameter("sessionPreregisterIng")!=null){
        ...
        File reportFile = new File(application.getRealPath("content/data-jr/documentPreregisterIng/preregisterPDF.jasper")); 
