...
<% 
 if(true){    
    if(request.getParameter("sessionCeduleIng")!=null){
        ...
        File reportFile = new File(application.getRealPath("content/data-jr/documentPreregisterIng/preregister-cedulePDF.jasper")); 
