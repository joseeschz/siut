...
<% 
 if(session.getAttribute("logueado") != null){
    if(request.getParameter("sessionLetterCommitment")!=null){
        ...
        File reportFile = new File(application.getRealPath("content/data-jr/letterCommitmentIng/letterCommitment.jasper")); 
