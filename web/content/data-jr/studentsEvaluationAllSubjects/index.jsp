...
<% 
 if(session.getAttribute("logueado") != null){
    if(request.getParameter("sessionCalificationsByStudentsAllMatters")!=null){
        ...
        File reportFile = new File(application.getRealPath("content/data-jr/studentsEvaluationAllSubjects/report.jasper")); 
