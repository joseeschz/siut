...
<% 
 if(session.getAttribute("logueado") != null){
    if(request.getParameter("sessionStudentsByGroup")!=null){
        ...
        File reportFile = new File(application.getRealPath("content/data-jr/studentsByGroup/report-group-by-students.jasper")); 
