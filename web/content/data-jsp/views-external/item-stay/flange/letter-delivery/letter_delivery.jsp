...
if(session.getAttribute("logueado") != null){%>
    <script>
        $(document).ready(function (){
            ...
            $("#transactLowTab").load("../content/data-jsp/views-external/item-stay/flange/letter-delivery/letter-delivery-flange/index.jsp");
        });
    </script>
    ...
    <div id='jqxTabs'>
        <ul>
            <li class="jqxTabsTitle" dir="letter-delivery">Cartas de Liberación</li>
        </ul>
        <div>
