...
if(session.getAttribute("logueado") != null){%>
    <script>
        $(document).ready(function (){
            ...
            $("#debtsTab").load("../content/data-jsp/views-external/item-students/flange/debts/debts-flange/admin.jsp");
        });
    </script>
    ...
    <div id='jqxTabs'>
        <ul>
            <li class="jqxTabsTitle" dir="payment">Registrar deudas de alumnos</li>
        </ul>
        <div>
            <div class="hidenTab" style="display: none;">
                <div id="debtsTab" style="padding: 20px;"></div>
            </div>
        </div>
    </div>
<%}else{
