...
if(session.getAttribute("logueado") != null){%>
    <script>
        $(document).ready(function (){
            ...
            $('#jqxWindowWarningRattings').jqxWindow({
                theme: theme,
                height: 100,
                width: 350,
                resizable: false,
            ...
            $('#jqxWindowWarningRattingsNew').jqxWindow({
                theme: theme,
                height: 220,
                width: 450,
                resizable: false,
            ...
            $('#jqxWindowErrorRattings').jqxWindow({
                theme: theme,
                height: 150,
                width: 350,
                resizable: false,
            ...
            $("#newRattingsTab").load("../content/data-jsp/views-external/item-students/flange/adjustment/rattings/tab-new/index.jsp");
        });
    </script>
    <div id='jqxWindowOk'>
        <div>Bien</div>
    ...
    <div id='jqxWindowWarningRattings'>
        <div>Advertencia</div>
        <div>
    ...
    <div id='jqxWindowWarningRattingsNew'>
        <div>Advertencia</div>
        <div>
            <div class="warning" style="position: absolute;"></div>
            <span style="color: olive; width: 70%; position: absolute; right: 20px;">
