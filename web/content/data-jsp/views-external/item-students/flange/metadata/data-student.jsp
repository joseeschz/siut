...
$(document).ready(function () {
    ...
    var wizard = (function () {
        ...
        return {
            ...
            init: function () {
                $('#jqxWisard').jqxTabs({ height: "600px", width: "auto",  keyboardNavigation: false });
                $('.nextButton').jqxButton({ width: 80});
                $('.backButton').jqxButton({ width: 80});
...
//                }
    ...
    createInputEnrrollment("#enrollment",false);
    $("#enrollment").on('select',function (event){
        var enrollment="";
        var pkStudent;
        if(event.args){
    ...
    function  disableElements(status){
        $('#enrollment').jqxInput({disabled: !status});
         if(status){
            $('#enrollment').val("");
    ...
    function loadData(enrollment){
        $.ajax({
            ...
            data: {"enrrollmentStudent" : enrollment},
            async: true,
            beforeSend: function (xhr) {
...
<div id="medatadaUpdate">
    <div style="padding-left: 15px; width: 925px;">
        ...
        <div style="float: right; margin-right: 5px;">
            <div style="float: right; margin-right: 5px;">
                <span>Matrícula</span>
                <input type="text" id="enrollment" style="width: 140px; height: 26px" class="text-input" />
    ...
    <div style="overflow: hidden; position: relative;">
        <div id='jqxWisard'>
            ...
            <div class="section">
                ...
                <div id="basketButtonsWrapper">
                    <input type="button" value="Atras" class="backButton" />
                    <input type="button" value="Siguiente" class="nextButton disabled"/>
                </div>
            </div>
        </div>
