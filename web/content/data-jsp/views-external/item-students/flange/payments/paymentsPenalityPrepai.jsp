...
if(session.getAttribute("logueado") != null){%>
    <script>
        $(document).ready(function (){
            ...
            $("#paymentsPenaltyTypesPrepaiTab").load("../content/data-jsp/views-external/item-students/flange/payments/paymentsPenaltyTypesPrepai-flange/admin.jsp");
        });
    </script>
    ...
    <div id='jqxTabs'>
        <ul>
            <li class="jqxTabsTitle" dir="payment">Pago de cuotas prepago</li>
        </ul>
        <div>
