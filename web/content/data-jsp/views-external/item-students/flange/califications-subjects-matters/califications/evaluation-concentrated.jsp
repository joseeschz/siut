...
if(session.getAttribute("logueado") != null){%>
    <script>
        $(document).ready(function (){
            ...
            $("#evaluationStudentsTab").load("../content/data-jsp/views-external/item-students/flange/califications-subjects-matters/califications/students-evaluation-concentrated-flange/"+view+".jsp");
        });
    </script>
    <div id='jqxTabs'>
        <ul>
