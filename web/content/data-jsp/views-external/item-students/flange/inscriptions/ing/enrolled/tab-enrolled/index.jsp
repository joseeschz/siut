<script type="text/javascript">
    $(document).ready(function () {
        var itemCareer = 0;
        var itemPeriod = 0;
        createDropDownCareer( 2 ,"#careerFilter",false);
        ...
        var initDataTable = function () {
            ...
            var url = "../serviceStudent?selectStudentsING";
            // prepare the data
            var source =
            {
                datatype: "json",
...
//        contextMenu.jqxMenu('disable', 'generate', true); 
        ...
        $('#jqxDataTableEnrolled').on('rowDoubleClick', function (event){
            ...
            $.ajax({
                type: "POST",
                async: false,
                url: "../content/data-jsp/views-external/item-students/flange/inscriptions/ing/enrolled/tab-enrolled/expedient.jsp",
