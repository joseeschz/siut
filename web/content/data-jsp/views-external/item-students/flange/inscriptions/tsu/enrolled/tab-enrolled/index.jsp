<script type="text/javascript">
    $(document).ready(function () {
        var itemCareer = 0;
        var itemPeriod = 0;
        createDropDownCareer( 1 ,"#careerFilter",false);
...
//        contextMenu.jqxMenu('disable', 'generate', true); 
        ...
        $('#jqxDataTableEnrolled').on('rowDoubleClick', function (event){
            ...
            $.ajax({
                type: "POST",
                async: false,
                url: "../content/data-jsp/views-external/item-students/flange/inscriptions/tsu/enrolled/tab-enrolled/expedient.jsp",
