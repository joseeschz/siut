...
$(document).ready(function () {
    ...
    $('#registerForm').on('validationSuccess', function (event) {
        ...
        var datos = {"enrollment":$("#enrollment").text(),"nameStudent":$("#name").val(),"maternName":$("#matern_name").val(),"paternName":$("#patern_name").val(),"career":itemCareer.value,"fkPreparatory":itemPreparatory.value}; // los datos del 
        $.ajax({
            type: "POST",
            async: false,
...
<div id="formNewInscription">
    <div id="register">
        <div style="padding-left: 15px;">
            ...
            <b style="float: left; right: 0px; margin-left: 110px;">Preregistrado<div id="preregister" style="margin-top: 2px; margin-left: 55px;"></div></b>
            <div style="float: left; right: 0px; margin-left: 20px;">
