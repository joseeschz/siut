...
if(session.getAttribute("logueado") != null){%>
    <script>
        $(document).ready(function (){
            ...
            $("#newIncriptionTab").load("../content/data-jsp/views-external/item-students/flange/inscriptions/new-inscription.jsp");
            $("#updateIncriptionTab").load("../content/data-jsp/views-external/item-students/flange/inscriptions//update-inscription.jsp");
        });
    </script>
    <div id='jqxWindowOk'>
        <div>Bien</div>
    ...
    <div id='jqxTabs'>
        <ul>
            <li class="jqxTabsTitle" dir="new-inscription">Nueva inscripción</li>
            <li class="jqxTabsTitle" dir="update-inscription">Modificar registros</li>
        </ul>
        <div>
            <div class="hidenTab" style="display: none;">
                <div id="newIncriptionTab" style="padding: 20px;"></div>
            </div>
        </div>
        <div>
            <div class="hidenTab" style="display: none;">
