...
if(session.getAttribute("logueado") != null){%>
    <script>
        $(document).ready(function (){
            ...
            $("#qualificationsTab").load("../content/data-jsp/views-external/item-students/flange/average-matters-admin/verify-records-qualifications/qualifications-average.jsp");
        });
    </script>
