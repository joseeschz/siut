...
if(session.getAttribute("logueado") != null){%>
    <script>
        $(document).ready(function (){
            ...
            $("#consultRealTimeRateTab").load("../content/data-jsp/views-external/item-students/flange/average-matters-admin/real-time-rate-flange/consult-real-time-rate.jsp");
        });
    </script>
    <div id='jqxTabs'>
        <ul>
