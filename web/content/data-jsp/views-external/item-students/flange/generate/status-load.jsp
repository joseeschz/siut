...
if(session.getAttribute("logueado") != null){%>
    <script>
        $(document).ready(function (){
            ...
            $("#statusLoadPaymentTab").load("../content/data-jsp/views-external/item-students/flange/payments/statusLoadPayment-flange/admin.jsp");
        });
    </script>
    ...
    <div id='jqxTabs'>
        ...
        <div>
            <div class="hidenTab" style="display: none;">
                <div id="statusLoadPaymentTab" style="padding: 20px;"></div>
            </div>
        </div>
    </div>
<%}else{
