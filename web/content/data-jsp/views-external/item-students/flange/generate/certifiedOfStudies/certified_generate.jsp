...
if(session.getAttribute("logueado") != null){%>
    <script>
        $(document).ready(function (){
            ...
            $("#transactLowTab").load("../content/data-jsp/views-external/item-students/flange/generate/certifiedOfStudies/certified-generate-flange/index.jsp");
        });
    </script>
    ...
    <div id='jqxTabs'>
        <ul>
            <li class="jqxTabsTitle" dir="generate-certified">Certificados de Estudio</li>
        </ul>
        <div>
