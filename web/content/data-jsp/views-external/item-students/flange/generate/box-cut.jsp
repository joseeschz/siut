...
if(session.getAttribute("logueado") != null){%>
    <script>
        $(document).ready(function (){
            ...
            $("#boxCutTab").load("../content/data-jsp/views-external/item-students/flange/generate/box-cut-flange/admin.jsp");
        });
    </script>
    ...
    <div id='jqxTabs'>
        <ul>
            <li class="jqxTabsTitle" dir="box-cut">Realizar algún corte de caja</li>
        </ul>
        <div>
            <div class="hidenTab" style="display: none;">
                <div id="boxCutTab" style="padding: 20px;"></div>
            </div>
        </div>
    </div>
<%}else{
