...
if(session.getAttribute("logueado") != null){%>
    <script>
        $(document).ready(function (){
            ...
            $("#newIncriptionTab").load("../content/data-jsp/views-external/item-students/flange/pre-inscriptions/ing/new-external/tab-new/index.jsp");
        });
    </script>
    <div id='jqxWindowOk'>
        <div>Bien</div>
    ...
    <div id='jqxTabs'>
        <ul>
            <li class="jqxTabsTitle" dir="new-inscription">Nueva inscripción Ingeniería alumno sin Matrícula</li>
        </ul>
        <div>
