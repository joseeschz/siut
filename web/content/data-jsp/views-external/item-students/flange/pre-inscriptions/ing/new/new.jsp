...
if(session.getAttribute("logueado") != null){%>
    <script>
        $(document).ready(function (){
            ...
            $("#newIncriptionTab").load("../content/data-jsp/views-external/item-students/flange/pre-inscriptions/ing/new/new-tab/index.jsp");
        });
    </script>
    <div id='jqxWindowOk'>
        <div>Bien</div>
    ...
    <div id='jqxTabs'>
        <ul>
            <li class="jqxTabsTitle" dir="new-inscription">Nueva preinscripción a Ingeniería</li>
        </ul>
        <div>
