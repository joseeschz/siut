...
if(session.getAttribute("logueado") != null){%>
    <script>
        $(document).ready(function (){
            ...
            $("#authorizedIncriptionTab").load("../content/data-jsp/views-external/item-students/flange/pre-inscriptions/ing/authorized/authorized-tab/index.jsp");
        });
    </script>
    <div id='jqxWindowOk'>
        <div>Bien</div>
        <div>
            ...
            <span style="color: olive; width: 70%; position: absolute; right: 20px;">
                <b>Se ha autorizado correctamente el Pre-registro a este alumno</b>
            </span>
    ...
    <div id='jqxWindowWarningIncriptionsUpdate'>
        ...
        <div>
            ...
            <span style="color: olive; width: 70%; position: absolute; right: 20px;">
                <b>Autorizar el Pre-regtistro a este alumno...</b>
            </span>
            <div style="float: right; bottom: 10px; right: 20px;  position: absolute;">
    ...
    <div id='jqxTabs'>
        <ul>
            <li class="jqxTabsTitle" dir="authorized-inscription">Autorizar Pre-Registro ING</li>
        </ul>
        <div>
            <div class="hidenTab" style="display: none;">
                <div id="authorizedIncriptionTab" style="padding: 20px"></div>
            </div>
        </div>
    </div>
<%}else{
