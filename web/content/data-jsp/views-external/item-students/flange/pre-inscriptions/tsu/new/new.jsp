...
if(session.getAttribute("logueado") != null){%>
    <script>
        $(document).ready(function (){
            ...
            $("#newPre-IncriptionTab").load("../content/data-jsp/views-external/item-students/flange/pre-inscriptions/tsu/new/new-tab/index.jsp");
        });
    </script>
    <div id='jqxWindowOk'>
        <div>Bien</div>
    ...
    <div id='jqxTabs'>
        <ul>
            <li class="jqxTabsTitle" dir="new-pre-inscription">Nueva preinscripción TSU</li>
        </ul>
        <div>
