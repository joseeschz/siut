...
if(session.getAttribute("logueado") != null){%>
    <script>
        $(document).ready(function (){
            ...
            $("#allPre-IncriptionTab").load("../content/data-jsp/views-external/item-students/flange/pre-inscriptions/tsu/pre-registers/pre-registers-tab/index.jsp");
        });
    </script>
    <div id='jqxWindowOk'>
        <div>Bien</div>
    ...
    <div id='jqxTabs'>
        <ul>
            <li class="jqxTabsTitle" dir="new-pre-inscription">Preinscritos</li>
        </ul>
        <div>
