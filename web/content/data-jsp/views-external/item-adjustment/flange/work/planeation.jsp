...
if(session.getAttribute("logueado") != null){%>
    <script>
        $(document).ready(function (){
            ...
            $("#newWorkTab").load("../content/data-jsp/views-external/item-adjustment/flange/work/planeation-flange/work.jsp");
            $("#assingGroup").load("../content/data-jsp/views-external/item-adjustment/flange/work/planeation-flange/to-group.jsp");
        });
    </script>
    <div id='jqxWindowOk'>
        <div>Bien</div>
    ...
    <div id='jqxTabs'>
        <ul>
            <li class="jqxTabsTitle" dir="new-work">Trabajo</li>
            <li class="jqxTabsTitle" dir="assing-group">Asignación a un grupo</li>
        </ul>
        <div>
            <div class="hidenTab" style="display: none;">
                <div id="newWorkTab" style="padding: 20px;"></div>
            </div>
        </div>
        <div>
            <div class="hidenTab" style="display: none;">
                <div id="assingGroup" style="padding: 20px"></div>
            </div>
        </div>
    </div>
<%}else{
