...
if(session.getAttribute("logueado") != null){%>
    <script>
        $(document).ready(function (){
            ...
            $("#importDataTab").load("../content/data-jsp/views-external/item-catalogs/flange/academic-flange/external/import-flange/admin.jsp");
        });
    </script>
    <div id='jqxWindowWarning'>
        ...
        <div>
            ...
            <span style="color: olive; width: 70%; position: absolute; right: 20px;">
                <b>¡Estas seguro de borrar todos los registros!</b>
            </span>
    ...
    <div id='jqxTabs'>
        <ul>
            <li class="jqxTabsTitle" dir="payment">Importar datos externos de un archivo csv</li>
        </ul>
        <div>
            <div class="hidenTab" style="display: none;">
                <div id="importDataTab" style="padding: 20px;"></div>
            </div>
        </div>
    </div>
<%}else{
