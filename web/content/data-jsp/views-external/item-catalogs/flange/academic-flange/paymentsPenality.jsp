...
if(session.getAttribute("logueado") != null){%>
    <script>
        $(document).ready(function (){
            ...
            $("#paymentsPenaltyTypesTab").load("../content/data-jsp/views-external/item-catalogs/flange/academic-flange/paymentsPenaltyTypes/finances.jsp");
        });
    </script>
    ...
    <div id='jqxTabs'>
        <ul>
            <li class="jqxTabsTitle" dir="paymentsPenaltyTypes">Conceptos de pago por cuatrimestre y categorizado</li>
        </ul>
        <div>
            <div class="hidenTab" style="display: none;">
                <div id="paymentsPenaltyTypesTab" style="padding: 20px"></div>
            </div>
        </div>
    </div>
<%}else{
