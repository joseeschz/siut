...
if(session.getAttribute("logueado") != null){%>
    <script>
        $(document).ready(function (){
            ...
            $("#generationsTab").load("../content/data-jsp/views-external/item-catalogs/flange/academic-flange/generations/admin.jsp");
        });
    </script>
    ...
    <div id='jqxTabs'>
        <ul>
            <li class="jqxTabsTitle" dir="generations">Generaciones</li>
        </ul>
        <div>
            <div class="hidenTab" style="display: none;">
                <div id="generationsTab" style="padding: 20px"></div>
            </div>
        </div>
    </div>
<%}else{
