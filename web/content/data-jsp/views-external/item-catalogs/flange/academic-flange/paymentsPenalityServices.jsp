...
if(session.getAttribute("logueado") != null){%>
    <script>
        $(document).ready(function (){
            ...
            $("#paymentsPenaltyTypesServicesPrepaiTab").load("../content/data-jsp/views-external/item-catalogs/flange/academic-flange/paymentsPenaltyTypesServices/finances.jsp");
        });
    </script>
    ...
    <div id='jqxTabs'>
        <ul>
            <li class="jqxTabsTitle" dir="paymentsPenaltyTypesServicesPrepai">Conceptos de pago por cuatrimestre servicios y sanciones</li>
        </ul>
        <div>
            <div class="hidenTab" style="display: none;">
                <div id="paymentsPenaltyTypesServicesPrepaiTab" style="padding: 20px"></div>
            </div>
        </div>
    </div>
<%}else{
