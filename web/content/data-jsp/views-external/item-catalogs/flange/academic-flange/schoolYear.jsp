...
if(session.getAttribute("logueado") != null){%>
    <script>
        $(document).ready(function (){
            ...
            $("#schoolYearTab").load("../content/data-jsp/views-external/item-catalogs/flange/academic-flange/schoolYear/admin.jsp");
        });
    </script>
    ...
    <div id='jqxTabs'>
        <ul>
            <li class="jqxTabsTitle" dir="schoolYear">Ciclos Escolares</li>
        </ul>
        <div>
            <div class="hidenTab" style="display: none;">
                <div id="schoolYearTab" style="padding: 20px"></div>
            </div>
        </div>
    </div>
<%}else{
