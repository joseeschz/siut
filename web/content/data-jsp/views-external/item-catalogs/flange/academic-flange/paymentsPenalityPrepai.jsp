...
if(session.getAttribute("logueado") != null){%>
    <script>
        $(document).ready(function (){
            ...
            $("#paymentsPenaltyTypesPrepaiTab").load("../content/data-jsp/views-external/item-catalogs/flange/academic-flange/paymentsPenaltyTypesPrepai/finances.jsp");
        });
    </script>
    ...
    <div id='jqxTabs'>
        <ul>
            <li class="jqxTabsTitle" dir="paymentsPenaltyTypesPrepai">Conceptos de pago por cuatrimestre prepago</li>
        </ul>
        <div>
            <div class="hidenTab" style="display: none;">
                <div id="paymentsPenaltyTypesPrepaiTab" style="padding: 20px"></div>
            </div>
        </div>
    </div>
<%}else{
