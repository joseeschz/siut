...
if(session.getAttribute("logueado") != null){%>
    <script>
        $(document).ready(function (){
            ...
            $("#userAmissiblenessTab").load("../content/data-jsp/views-external/item-settings/flange/amissibleness-flange/amissibleness.jsp");
        });
    </script>
    ...
    <div id='jqxTabs'>
        <ul>
            <li class="jqxTabsTitle" dir="userAmissibleness">Permisos</li>
        </ul>
        <div>
            <div class="hidenTab" style="display: none;">
                <div id="userAmissiblenessTab" style="padding: 20px"></div>
            </div>
        </div>
    </div>
<%}else{
