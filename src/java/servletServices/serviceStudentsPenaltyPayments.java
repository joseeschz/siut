    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            if(request.getParameter("view")!=null){
                ...
                int statusPrepaid=Integer.parseInt(request.getParameter("pt_status_prepaid"));
                settings.put("__studentsPenaltyPaymentsModel","StudentsPenalityPayments");
                listStudentsPenalityPayments = new studentsPenaltyPaymentsControl().SelectStudentsPenaltyPayments(statusPrepaid, fkPeriod);
                for(int i=0;i<listStudentsPenalityPayments.size();i++){
                    ...
                    data.put("dataStatusPrepaid", listStudentsPenalityPayments.get(i).getFL_STATUS_PREPAID());
            ...
            if(request.getParameter("insert")!=null){
                ...
                try {
                    ...
                    dataStudentsPenalityPayments.setFL_STATUS_PREPAID(Integer.parseInt(request.getParameter("pt_status_prepaid")));
