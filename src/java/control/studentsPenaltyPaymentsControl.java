...
//        listStudentsPenalityPayments = new studentsPenaltyPaymentsControl().SelectStudentsPenaltyPayments(0, 14);
...
//        }
        ...
        dataStudentsPenalityPayments.setFL_STATUS_PREPAID(0);
        dataStudentsPenalityPayments.setFL_STATUS_PAYMENT("0");
    ...
    public ArrayList<studentsPenaltyPaymentsModel> SelectStudentsPenaltyPayments(int pt_status_prepaid, int pt_fk_period){
        ...
        try (Connection conn = new conectionControl().getConexion(); PreparedStatement ps = conn.prepareStatement(procedure)) { 
            ...
            try (ResultSet res = ps.executeQuery()) {
                while(res!=null&&res.next()){
                    ...
                    allStudentsPenaltyPayment.setFL_STATUS_PREPAID(res.getInt("FL_STATUS_PREPAID"));
    ...
    public String[] InsertStudentsPenaltyPayment(studentsPenaltyPaymentsModel dataStudentsPenaltyPayment){
        ...
        try {
            ...
            ps.setInt(6, dataStudentsPenaltyPayment.getFL_STATUS_PREPAID());
            ps.setString(7, dataStudentsPenaltyPayment.getFL_STATUS_PAYMENT());
            ps.executeUpdate();
